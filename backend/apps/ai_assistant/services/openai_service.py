...
class OpenAIRuralAssistant:
    ...
    def moderate(self, text):
        try:
            result = self.client.moderations.create(model="omni-moderation-latest", input=text).results[0]
    ...
    def generate(self, *, user, conversation, question, history):
        request_input = [
        ...
        return GeneratedAnswer(
            ...
            model=getattr(response, "model", settings.OPENAI_AI_MODEL),
