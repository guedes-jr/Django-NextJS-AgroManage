...
urlpatterns = [
    ...
    path("ai/dashboard/", views.ai_dashboard, name="platform-ai-dashboard"),
    path("ai/providers/", views.ai_providers, name="platform-ai-providers"),
    path("ai/providers/<uuid:provider_id>/", views.update_ai_provider, name="platform-ai-provider-detail"),
    path("ai/models/", views.ai_models, name="platform-ai-models"),
    path("ai/models/<uuid:model_id>/", views.update_ai_model, name="platform-ai-model-detail"),
    path("ai/model-sync-runs/", views.ai_model_sync_runs, name="platform-ai-model-sync-runs"),
    path("ai/model-sync/", views.trigger_ai_model_sync, name="platform-ai-model-sync"),
    path("ai/organizations/<uuid:organization_id>/", views.update_organization_ai, name="platform-ai-organization"),
