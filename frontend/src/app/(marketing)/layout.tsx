...
export default function MarketingLayout({ children }: { children: React.ReactNode }) {
  ...
  const organization={"@context":"https://schema.org","@type":"Organization",name:"Fazenda Mais",url:siteUrl,logo:`${siteUrl}/logo_agro_leaf.png`,email:"contato@agromanage.com",contactPoint:{"@type":"ContactPoint",contactType:"sales",email:"contato@agromanage.com",availableLanguage:"Portuguese"}};
