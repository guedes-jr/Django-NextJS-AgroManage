...
const faqs = [
  ["Preciso instalar algum programa?", "Não. O sistema Fazenda Mais é acessado pelo navegador e funciona em computadores, tablets e celulares conectados à internet."],
...
export default function MarketingHomePage() {
  return <>
    ...
    <main>
      ...
      <section className="final-cta"><div className="marketing-container final-cta-card"><div><div className="eyebrow light">Pronto para organizar sua operação?</div><h2>Leve mais clareza para cada decisão no campo.</h2><p>Conheça o sistema Fazenda Mais em uma demonstração orientada à realidade da sua propriedade.</p></div><div className="final-cta-actions"><Link href="/contato" className="marketing-button light">Solicitar demonstração <ArrowRight size={18}/></Link><Link href="/planos" className="marketing-button outline-light">Ver planos</Link></div></div></section>
    </main>
    <MarketingFooter />
  </>;
}
