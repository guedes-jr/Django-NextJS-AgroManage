  ...
  return (
    <div className="p-4">
      <div className="d-flex justify-content-between align-items-center mb-4">
        <div>
          <h4 className="fw-bold mb-1">Relatório Geral</h4>
          <p className="text-muted mb-0">Visão geral consolidada</p>
        </div>
      </div>
          ...
          <div className="card border-0 shadow-sm h-100">
            <div className="card-body">
              <div className="d-flex align-items-center gap-3 mb-3">
                ...
                <div>
                  <div className="text-muted small">Valor Estoque</div>
        ...
        <div className="col-md-6">
          <div className="card border-0 shadow-sm">
            <div className="card-header bg-white border-0 py-3">
              <h6 className="fw-bold mb-0">Acesso Rápido</h6>
            </div>
              ...
              <div className="list-group list-group-flush">
                ...
                >
                  ...
                  <div className="flex-grow-1 text-start">
                    <div className="fw-medium">Estoque</div>
                    <div className="text-muted small">Ver detalhes</div>
                  </div>
                ...
                >
                  ...
                  <div className="flex-grow-1 text-start">
                    <div className="fw-medium">Rebanho</div>
                    <div className="text-muted small">Ver detalhes</div>
                  </div>
                  <ArrowRight size={16} className="text-muted" />
                </button>
