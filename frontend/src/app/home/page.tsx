...
interface LivestockSegment extends Segment { code:string; name:string }
interface DashboardData { organization:string|null; kpis:DashboardKpis; charts:{ revenue_vs_expense:RevenueItem[]; herd_by_species?:Breakdown[] }; segments:{ crops:Segment; livestock:Segment; livestock_by_species?:LivestockSegment[] }; recent_activities:RecentItem[]; tasks:TaskItem[] }
