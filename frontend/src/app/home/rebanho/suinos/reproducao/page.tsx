...
function ReproducaoPageContent() {
  ...
  const config: ReproducaoConfig = useMemo(() => ({
    ...
    flowSteps: [
      ...
      { id: "gestacao", icon: "🤰", label: "Gestação", count: tab.gestacao?.rows?.length ?? 0, color: "#fff8ed", borderColor: "#fed7aa", accent: "#e98727", image: "/images/reproduction/gestacao.png", summary: `${g.parto_proximo ?? 0} próximas ao parto` },
