...
const TABS = [
  ...
  { id: "vacas", label: "Vacas", icon: <Milk size={18} /> },
  { id: "touros", label: "Touros", icon: <Beef size={18} /> },
  { id: "bezerros", label: "Bezerros", icon: <Baby size={18} /> },
  { id: "producao", label: "Produção de Ração", icon: <FlaskConical size={18} /> },
];

export default function BovinosRacaoPage() {
  ...
  return (
    <div className="animate-fade-in inventory-container">
      ...
      <div className="d-flex align-items-center justify-content-between mb-4">
        <div>
          <nav className="d-flex align-items-center gap-2 small text-muted-foreground mb-2">
            ...
            <ChevronRight size={14} />
            <span className="fw-semibold text-foreground">Bovinos</span>
          </nav>
      ...
      {activeTab === "producao" ? (
        <FeedProductionDashboard species="bovino" showHeader={false} />
      ) : (
