...
export function MarketingFooter() {
  return <footer className="marketing-footer">
    <div className="marketing-container footer-grid">
      <div><div className="footer-brand"><Sprout size={22} /> Fazenda Mais</div><p>Tecnologia para decisões melhores no campo.</p></div>
    ...
    <div className="marketing-container footer-bottom">© {new Date().getFullYear()} Fazenda Mais. Todos os direitos reservados.</div>
  </footer>;
}
