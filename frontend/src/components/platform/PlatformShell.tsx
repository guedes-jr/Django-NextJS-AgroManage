...
import { Activity, Bot, Building2, ClipboardList, CreditCard, Eye, Handshake, LayoutDashboard, LogOut, RefreshCw, ScrollText, Settings, ShieldCheck, Tags, Terminal, UserCog, Users, WalletCards } from "lucide-react";
...
const navigation = [
  ...
  { href: "/platform/payment-gateways", label: "Gateways", icon: CreditCard },
  { href: "/platform/operations", label: "Operações", icon: Activity },
  { href: "/platform/ai", label: "Inteligência artificial", icon: Bot },
      ...
      <aside className="platform-sidebar">
        ...
        <nav className="platform-nav">
          ...
          {[
            ...
            <Link href="/platform/affiliates" className={pathname.startsWith("/platform/affiliates") ? "active" : ""}>
              <Handshake size={19} /><span className="nav-label">Afiliados</span>
            </Link>
          )}
